...
10. **其他个人行为专题**：
    ...
    3. 现阶段 `GGN_2015` 还是习惯性地使用 “您” 这个字做第二人称代词。
       ...
       3. 在与其他人沟通时，`GGN_2015` **应该**（SHOULD）避免使用第二人称代词，转而使用而具有个人相关性的指代方式，具体如下。
          1. 优先使用经过约定俗成的方式称呼彼此，很可能是一种代号。
          2. 当缺乏代号时，**可以**（MAY）商议代号，或者直接用去掉姓氏的名字称呼对方。
          3. 对待不太熟悉，没有商议过代号的情况，**应该**（SHOULD）延续使用 “您” 作为第二人称代词的习惯。
...
8. **婚恋专题**：
   ...
   4. `GGN_2015` 是一个**坚定的独身主义者**，无论是否有自认为志趣相合的人，`GGN_2015` **应该**（SHOULD）保持单身.
      1. `GGN_2015` **应当**（SHOULD）拒绝恋爱，**应当**（SHOULD）拒绝婚姻。
